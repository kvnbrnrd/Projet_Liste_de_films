...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 28 nov. 2018 à 14:42
...
CREATE TABLE IF NOT EXISTS `films_acteurs` (
  ...
  PRIMARY KEY (`id_acteur`,`id_films`),
  KEY `films_acteurs_Films0_FK` (`id_films`)
...
INSERT INTO `films_acteurs` (`id_acteur`, `id_films`) VALUES
(50, 1),
(53, 1),
(67, 1),
(69, 2),
...
CREATE TABLE IF NOT EXISTS `genres_films` (
  ...
  KEY `genres_films_Films0_FK` (`id_films`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `genres_films` (`id_genre`, `id_films`) VALUES
(1, 1),
(7, 1),
(5, 2),
(7, 2),
...
ALTER TABLE `films_acteurs`
  ...
  ADD CONSTRAINT `films_acteurs_Films0_FK` FOREIGN KEY (`id_films`) REFERENCES `films` (`id_film`);
...
ALTER TABLE `genres_films`
  ADD CONSTRAINT `genres_films_Films0_FK` FOREIGN KEY (`id_films`) REFERENCES `films` (`id_film`),
